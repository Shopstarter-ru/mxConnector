...
class mxConnectorTaxonUpdateProcessor extends modObjectUpdateProcessor
{
    ...
    public function beforeSet()
    {
        ...
        if (empty($id)) {
            return $this->modx->lexicon('mxconnector_taxon_err_ns');
        }
...
return 'mxConnectorTaxonUpdateProcessor';
